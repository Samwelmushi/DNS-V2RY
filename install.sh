...
EOF
        ...
        echo ""
        echo -e "${WHITE}Or use these details:${NC}"
        echo -e "${CYAN}Address: ${GREEN}127.0.0.1${NC}"
        echo -e "${CYAN}Port: ${GREEN}7000${NC}"
        echo -e "${CYAN}UUID: ${GREEN}${V2RAY_UUID}${NC}"
        echo -e "${CYAN}AlterID: ${GREEN}0${NC}"
        echo -e "${CYAN}Network: ${GREEN}tcp${NC}"
        echo -e "${CYAN}Security: ${GREEN}none${NC}"
        ...
        echo -e "${CYAN}Address: ${GREEN}127.0.0.1${NC}"
        echo -e "${CYAN}Port: ${GREEN}7000${NC}"
        echo -e "${CYAN}Password: ${GREEN}${V2RAY_PASSWORD}${NC}"
        echo -e "${CYAN}Network: ${GREEN}tcp${NC}"
        echo -e "${CYAN}Security: ${GREEN}none${NC}"
    fi
    ...
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}                   SETUP STEPS${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${WHITE}1. Add DNS records (A and NS) to your domain${NC}"
    echo -e "${WHITE}2. Run DNSTT client command on your device${NC}"
    echo -e "${WHITE}3. Import V2Ray config link to your V2Ray app${NC}"
    echo -e "${WHITE}4. Connect and enjoy!${NC}"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
