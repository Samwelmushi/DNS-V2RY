...
display_connection_info() {
    ...
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}              HOW TO USE WITH HTTP CUSTOM / HTTP INJECTOR${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}📱 FOR ANDROID (HTTP Custom - ONE APP ONLY):${NC}"
    echo ""
    echo -e "${YELLOW}Step 1: Install HTTP Custom${NC}"
    echo -e "  • Download ${CYAN}HTTP Custom${NC} from Google Play Store"
    echo -e "  • This ONE app does everything (Slow DNS + V2Ray)"
    echo ""
    echo -e "${YELLOW}Step 2: Enable V2Ray Plugin${NC}"
    echo -e "  • Open HTTP Custom"
    echo -e "  • Click the ${CYAN}Plugin icon${NC} (top left)"
    echo -e "  • Select ${CYAN}'SlowDNS V2Ray'${NC} or ${CYAN}'V2Ray DNS'${NC}"
    echo -e "  • Check/Enable the plugin"
    echo ""
    echo -e "${YELLOW}Step 3: Import V2Ray Configuration${NC}"
    echo -e "  • Copy the ${GREEN}VMess link${NC} shown above"
    echo -e "  • In HTTP Custom, click the ${CYAN}clipboard icon${NC} (top left)"
    echo -e "  • The VMess config will be imported automatically"
    echo ""
    echo -e "${YELLOW}Step 4: Configure Slow DNS Settings${NC}"
    echo -e "  • Go to ${CYAN}Settings${NC} → ${CYAN}Slow DNS${NC}"
    echo -e "  • Enable ${CYAN}'Use Slow DNS'${NC}"
    echo -e "  • ${CYAN}DNS Server:${NC} ${GREEN}169.255.187.58${NC} or ${GREEN}8.8.8.8${NC}"
    echo -e "  • ${CYAN}DNS Port:${NC} ${GREEN}53${NC}"
    echo -e "  • ${CYAN}Pubkey:${NC} ${GREEN}${PUBKEY}${NC}"
    echo -e "  • ${CYAN}Nameserver:${NC} ${GREEN}${DOMAIN}${NC}"
    echo ""
    echo -e "${YELLOW}Step 5: Additional Settings (Optional)${NC}"
    echo -e "  • ${CYAN}Payload:${NC} GET / HTTP/1.1[crlf]Host: ${DOMAIN}[crlf][crlf]"
    echo -e "  • ${CYAN}SNI/Bug Host:${NC} ${DOMAIN}"
    echo ""
    echo -e "${YELLOW}Step 6: Connect${NC}"
    echo -e "  • Click the ${CYAN}'START'${NC} or ${CYAN}'CONNECT'${NC} button"
    echo -e "  • Wait 10-15 seconds for connection"
    echo -e "  • You're connected! 🎉"
    echo ""
    echo -e "${WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}💻 FOR WINDOWS/PC:${NC}"
    echo ""
    echo -e "${YELLOW}You need to run DNSTT Client + V2Ray separately on PC${NC}"
    echo ""
    echo -e "${YELLOW}Step 1: Run DNSTT Client${NC}"
    echo -e "  • Download from: ${CYAN}https://www.bamsoftware.com/software/dnstt/${NC}"
    echo -e "  • Save public key to ${CYAN}server.pub${NC}"
    echo -e "  • Run command:"
    echo -e "    ${GREEN}dnstt-client -doh https://cloudflare-dns.com/dns-query -pubkey-file server.pub ${DOMAIN} 127.0.0.1:7000${NC}"
    echo -e "  • Keep this terminal window open!"
    echo ""
    echo -e "${YELLOW}Step 2: Run V2Ray Client (V2RayN)${NC}"
    echo -e "  • Download V2RayN from: ${CYAN}https://github.com/2dust/v2rayN/releases${NC}"
    echo -e "  • Import the VMess link above"
    echo -e "  • Or manually configure:"
    echo -e "    - Address: ${GREEN}127.0.0.1${NC}"
    echo -e "    - Port: ${GREEN}7000${NC}"
    echo -e "    - UUID: ${GREEN}${V2RAY_UUID}${NC}"
    echo -e "    - AlterID: ${GREEN}0${NC}"
    echo -e "    - Network: ${GREEN}tcp${NC}"
    echo -e "  • Connect and browse!"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}              VMESS LINK (Copy & Paste into HTTP Custom)${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${GREEN}${VMESS_LINK}${NC}"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}                   CONFIGURATION SUMMARY${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}DNS Records (Add to your domain):${NC}"
    echo -e "  A Record:  ${YELLOW}ns.$DOMAIN${NC} → ${YELLOW}$SERVER_IP${NC}"
    echo -e "  NS Record: ${YELLOW}$DOMAIN${NC} → ${YELLOW}ns.$DOMAIN${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}HTTP Custom Settings:${NC}"
    echo -e "  Plugin: ${YELLOW}SlowDNS V2Ray${NC}"
    echo -e "  DNS Server: ${YELLOW}169.255.187.58${NC} or ${YELLOW}8.8.8.8${NC}"
    echo -e "  DNS Port: ${YELLOW}53${NC}"
    echo -e "  Pubkey: ${YELLOW}${PUBKEY}${NC}"
    echo -e "  Nameserver: ${YELLOW}${DOMAIN}${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}V2Ray Settings (Already in VMess link):${NC}"
    if [[ $V2RAY_PROTOCOL == "trojan" ]]; then
        echo -e "  Protocol: ${YELLOW}${V2RAY_PROTOCOL}${NC}"
        echo -e "  Password: ${YELLOW}${V2RAY_PASSWORD}${NC}"
    else
        echo -e "  Protocol: ${YELLOW}${V2RAY_PROTOCOL}${NC}"
        echo -e "  UUID: ${YELLOW}${V2RAY_UUID}${NC}"
        echo -e "  AlterID: ${YELLOW}0${NC}"
    fi
    echo -e "  Address: ${YELLOW}127.0.0.1${NC}"
    echo -e "  Port: ${YELLOW}7000${NC}"
    ...
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}If connection fails:${NC}"
    echo -e "  1. Make sure DNS records are added correctly"
    echo -e "  2. Wait 24-48 hours for DNS propagation"
    echo -e "  3. Try different DNS: 169.255.187.58 or 8.8.8.8 or 1.1.1.1"
    echo -e "  4. Check Slow DNS is enabled in HTTP Custom"
    echo -e "  5. Make sure V2Ray plugin is activated"
    echo -e "  6. Try reimporting the VMess link"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${RED}${BOLD}⚠ IMPORTANT: Copy the VMess link and all settings above!${NC}"
    echo -e "${RED}${BOLD}   This information will not be saved to any file.${NC}"
    echo ""
    
    read -p "$(echo -e ${YELLOW}Press Enter after you have copied all information...${NC})"
}
