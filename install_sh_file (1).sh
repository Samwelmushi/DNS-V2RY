...
EOF
    ...
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}         DNSTT CLIENT COMMAND (Run on your device)${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${GREEN}dnstt-client -doh https://cloudflare-dns.com/dns-query -pubkey ${PUBKEY} ${DOMAIN} 127.0.0.1:7000${NC}"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${YELLOW}${BOLD}                   QUICK SETUP GUIDE${NC}"
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}Step 1: Configure DNS Records${NC}"
    echo -e "  Add A record: ${YELLOW}ns.$DOMAIN${NC} → ${YELLOW}$SERVER_IP${NC}"
    echo -e "  Add NS record: ${YELLOW}$DOMAIN${NC} → ${YELLOW}ns.$DOMAIN${NC}"
    echo ""
    echo -e "${WHITE}${BOLD}Step 2: Run DNSTT Client${NC}"
    echo -e "  Copy the DNSTT client command above and run it on your device"
    echo ""
    echo -e "${WHITE}${BOLD}Step 3: Configure V2Ray App${NC}"
    echo -e "  ${CYAN}Option A:${NC} Scan QR code or import the link above"
    echo -e "  ${CYAN}Option B:${NC} Manually enter the configuration details"
    echo ""
    echo -e "${WHITE}${BOLD}Step 4: Connect${NC}"
    echo -e "  Start V2Ray app and enjoy your connection!"
    echo ""
    echo -e "${CYAN}${BOLD}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo -e "${RED}${BOLD}⚠ IMPORTANT: Copy all details above before pressing Enter!${NC}"
